...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      // 프로젝트 전용 토큰 (플러그인 미제공)
      borderRadius: { krds: '6px', 'krds-lg': '12px', 'krds-xl': '20px' },
      maxWidth: { container: '1200px' },
      // KRDS 공식 엘리베이션 (design/krds/krds_tokens.css: alpha-shadow1/2/3 = 5%/8%/12%).
      // 2단계: 카드/드롭다운(낮음) · 팝오버/모달(높음). 어림값 대신 공식 조합 그대로.
      boxShadow: {
        soft: '0 0 0.2rem 0 #0000000d, 0 0.4rem 0.8rem 0 #00000014',
        card: '0 0 0.2rem 0 #0000000d, 0 0.4rem 0.8rem 0 #00000014',
        'card-hover': '0 0 0.2rem 0 #00000014, 0 0.8rem 1.6rem 0 #0000001f',
        pop: '0 0 0.2rem 0 #00000014, 0 0.8rem 1.6rem 0 #0000001f',
      },
      backgroundImage: {
        'hero-fade': 'linear-gradient(135deg, #eaf1ff 0%, #f5f8ff 45%, #ffffff 100%)',
      },
      keyframes: {
        'fade-up': {
